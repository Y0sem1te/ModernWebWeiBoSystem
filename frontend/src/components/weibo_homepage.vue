<template>
  <div class="weibo-layout">
    ...
    <div class="left-nav">
      ...
      <div class="nav-menu">
        <div v-for="item in filteredNavItems" :key="item.name" class="menu-item" @click="go(item.name)">
    ...
    <div class="key-part">
          ...
          <div class="WeiBo-item" v-for="weibo in weibos" :key="weibo.id">
            <div class="justify-WeiBo-item">
              <div class="show-item">
                ...
                <el-button type="primary" :icon="Delete" style="margin-left:30px;" v-if="checkDelete(weibo.uid)"
              ...
              <div class="user-content">
                ...
                <div>
                  <video width="735" v-if="weibo.video != 'http://127.0.0.1:8088/images/'" controls :src="weibo.video"
                    style="margin-top:5px;"></video>
                </div>
      ...
      <div class="deal_list" v-if="isRoot">
        <h2>等待审核</h2>
        <!--cxy-->
        <div class="WeiBo-list">
          <div class="WeiBo-item" v-for="weibo in dweibos" :key="weibo.id">
            <div class="justify-WeiBo-item">
              <div class="show-item">
                <div class="pic-describe">
                  <div class="pic"><!--avatar-->
                ...
                <el-button type="primary" :icon="Delete" style="margin-left:30px;"
                  @click="delete_weibo(weibo.id)" />
                <el-button type="success" plain @click="pass(weibo.id)">Success</el-button>
              </div>
              <div class="user-content">
                <div class="character">
                  {{ weibo.content }}
...
export default {
  ...
  computed: {
    isRoot() {
      return this.fello === 6 && this.user.name === 'root';
    },
    filteredNavItems() {
  ...
  methods: {
    pass(wid){
      axios.post("http://127.0.0.1:8088/pass",{id:wid}).then(response =>{
        alert(response.data);
        location.reload();
      })
    },
    ...
    radomly_fetch() {
      ...
      try {
        axios.post("http://127.0.0.1:8088/review", { id: sessionStorage.getItem('username') }).then((response) => {
          //console.log(response)
          this.dweibos = response.data.map(weibo => ({
            ...weibo,
            showComments: false,
          }));
          console.log(this.dweibos)
